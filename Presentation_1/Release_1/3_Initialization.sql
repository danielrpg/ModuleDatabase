...
begin
	...
	INSERT INTO program_sso_activities (sso_detail_id, created_on, updated_on, sso_detail_activities, sso_detail_goal, so_detail_number, sso_detail_time, soo_detail_type, sso_id, sso_trainer_id) 
		VALUES (134,'2018-05-27 23:56:44', null, 'Identificar los riesgos a los que estan expuestos los empleados', 'Los empleados identifique por su cuenta los riesgos en sus areas de trabajo', 20, '3 d�as', 'Capacitaci�n', 1, 1);
	INSERT INTO program_sso_activities (sso_detail_id, created_on, updated_on, sso_detail_activities, sso_detail_goal, so_detail_number, sso_detail_time, soo_detail_type, sso_id, sso_trainer_id) 
		VALUES (135,'2018-05-27 23:56:44', null, 'Identificar nuevas normas', 'Los empleados deben estar actualizados con las nuevas normas', 20, '1 d�a', 'Capacitaci�n', null, null);
	INSERT INTO program_sso_activities (sso_detail_id, created_on, updated_on, sso_detail_activities, sso_detail_goal, so_detail_number, sso_detail_time, soo_detail_type, sso_id, sso_trainer_id) 
		VALUES (136,'2018-05-27 23:56:44', null, 'Identificar acciones a tomar en caso de accidentes', 'Los empleados deben estar conscientes de las acciones que deben ejecutar frente a un accidente', 20, '2 d�a', 'Capacitaci�n', null, null);
...
begin
	...
	INSERT INTO dbo.program_sso_resource (sso_resource_id, created_on, updated_on, sso_resource_cost, sso_resource_detail, sso_detail_id) 
		VALUES (1, '2018-05-27 23:56:44', null, 200, 'Hojas tama�o carta', 134);
	INSERT INTO dbo.program_sso_resource (sso_resource_id, created_on, updated_on, sso_resource_cost, sso_resource_detail, sso_detail_id) 
...
begin
	...
	INSERT INTO dbo.areas (area_id, created_on, updated_on, area_description, area_name) 
		VALUES (1, '2018-05-27 23:56:43', null, 'Dise�os de casas, habitaciones, otros ambientes.', 'Dise�o');
	INSERT INTO dbo.areas (area_id, created_on, updated_on, area_description, area_name) 
	...
	INSERT INTO dbo.areas (area_id, created_on, updated_on, area_description, area_name) 
		VALUES (4, '2018-05-27 23:56:43', null, 'Trabajos en metal para adaptaci�n de Galpones  y Carpinter�a met�lica para puertas, barandas, otros.', 'Galpones  y Carpinter�a met�lica');
	INSERT INTO dbo.areas (area_id, created_on, updated_on, area_description, area_name) 
		VALUES (5, '2018-05-27 23:56:43', null, 'Instalaciones h�dricas para ambientes como cocinas, ba�os, lavander�a, duchas, piscinas, jardines, etc.', 'Instalaciones h�dricas');
	INSERT INTO dbo.areas (area_id, created_on, updated_on, area_description, area_name) 
		VALUES (6, '2018-05-27 23:56:43', null, 'Instalaciones el�ctricas en los diferentes ambientes donde se trabaje.', 'Instalaciones el�ctricas');
	INSERT INTO dbo.areas (area_id, created_on, updated_on, area_description, area_name) 
		VALUES (7, '2018-05-27 23:56:43', null, 'Trabajos relacionados a la obra gruesa en la construcci�n, como ser estructura en las edificaciones, muros, pisos, pavimentos, techado, etc.', 'Obra gruesa');
	INSERT INTO dbo.areas (area_id, created_on, updated_on, area_description, area_name) 
		VALUES (8, '2018-05-27 23:56:43', null, 'Trabajos relacionados a la obra fina en la construcci�n, como ser revoque de paredes, cielo raso, cer�mica, etc. para puertas, barandas, otros.', 'Obra fina');
